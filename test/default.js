...
describe('default', function() {
  ...
  it('pagination enabled', function() {
    ...
    result[0].path.should.eql('en/categories/foo/');
    result[0].data.base.should.eql('en/categories/foo/');
    result[0].data.total.should.eql(2);
    result[0].data.current.should.eql(1);
    result[0].data.current_url.should.eql('en/categories/foo/');
    ...
    result[0].data.next_link.should.eql('en/categories/foo/page/2/');
    result[0].data.category.should.eql('foo');

    result[1].path.should.eql('en/categories/foo/page/2/');
    result[1].data.base.should.eql('en/categories/foo/');
    result[1].data.total.should.eql(2);
    result[1].data.current.should.eql(2);
    result[1].data.current_url.should.eql('en/categories/foo/page/2/');
    result[1].data.posts.eq(0)._id.should.eql(posts[2]._id);
    result[1].data.prev.should.eql(1);
    result[1].data.prev_link.should.eql('en/categories/foo/');
    result[1].data.next.should.eql(0);
    result[1].data.next_link.should.eql('');
    result[1].data.category.should.eql('foo');

    result[2].path.should.eql('en/categories/bar/');
    result[2].data.base.should.eql('en/categories/bar/');
    result[2].data.total.should.eql(1);
    result[2].data.current.should.eql(1);
    result[2].data.current_url.should.eql('en/categories/bar/');
  ...
  it('pagination disabled', function() {
    ...
    result[1].path.should.eql('en/categories/bar/');
    result[1].data.base.should.eql('en/categories/bar/');
    result[1].data.total.should.eql(1);
    result[1].data.current.should.eql(1);
    result[1].data.current_url.should.eql('en/categories/bar/');
  ...
  it('custom pagination_dir', function() {
    ...
    result.map(function(item) {
      return item.path;
    }).should.eql(['en/categories/foo/', 'en/categories/foo/yo/2/', 'en/categories/bar/']);
